export const tokens = {
  colors: {
    ...
    'text-brand-dark': 'text-brand-900',
  },
  backgrounds: {
    // Primitives
    'bg-brand-900': 'bg-brand-900',
    'bg-brand-700': 'bg-brand-700',
    'bg-brand-600': 'bg-brand-600',
    'bg-brand-500': 'bg-brand-500',
    'bg-brand-100': 'bg-brand-100',
    'bg-brand-50': 'bg-brand-50',
    'bg-neutral-900': 'bg-neutral-900',
    'bg-neutral-800': 'bg-neutral-800', // Note: 800 not in vars yet, fallback to 900 or add
    ...
    // Semantic Aliases
    'bg-surface': 'bg-white',
    'bg-surface-alt': 'bg-neutral-50',
    'bg-surface-dark': 'bg-neutral-900',
    'bg-primary': 'bg-brand-600',
    'bg-secondary': 'bg-neutral-200',
  ...
  typography: {
    ...
    'display-sm': 'text-4xl font-bold tracking-tight', // Changed to 4xl to avoid overlap 
  ...
  fontFamily: {
    ...
    'libre-caslon': 'font-libre-caslon',
  ...
  border: {
    ...
    color: {
      ...
      'border-strong': 'border-neutral-500',
    },
    style: {
      'solid': 'border-solid',
